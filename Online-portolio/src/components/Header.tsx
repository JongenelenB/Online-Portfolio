...
export default function Header() {
  const socials = [
    { name: "Github", link: "https://github.com/JongenelenB?tab=repositories" },
        ...
        <div className="w-full max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mt-4">
              A enthousastic front end web developer from Belgium, Antwerp with
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <a
                href="#Projects"
                className="relative inline-flex items-center justify-center p-0.5 rounded-lg bg-gradient-to-br from-pink-500 to-orange-400 cursor-pointer"
              >
                <span className="px-6 py-3 bg-white rounded-md font-medium text-gray-900 hover:bg-transparent hover:text-white transition-all duration-300 block w-full">
                  View My Projects
                </span>
              </a>
