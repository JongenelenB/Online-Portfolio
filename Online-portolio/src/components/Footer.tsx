...
export default function Contact() {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Sla het formulier op in een constante
  ...
  return (
    <section
      id="Contact"
      className="w-full h-auto flex flex-col items-center justify-center pt-32 pb-0 bg-gray-50"
    >
      <div className="w-full max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-xl mx-auto lg:mx-0 mt-4 leading-relaxed">
            ...
            a message. I'm always open to discussing new projects, creative
            ...
            {[
              {
                ...
                title: "Email",
                value: "jongenelen.bjorn@gmail.com",
                link: "mailto:jongenelen.bjorn@gmail.com",
              },
              {
                icon: <Phone className="text-orange-500" />,
                title: "Phone",
                value: "+32 485 50 12 97",
                link: "tel:+32485501297",
              },
              {
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                required
                className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all resize-none"
            ...
            {status === "success" && (
              <motion.div
                ...
                className="flex items-center justify-center gap-2 text-green-600 font-medium bg-green-50 py-3 rounded-lg border border-green-100"
              >
