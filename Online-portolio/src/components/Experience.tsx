  ...
  const events: TimelineEvent[] = [
    {
      ...
      direction: "left",
      content:
        "Acted as project manager for the implementation of an automated patching solution using Automox and Action1. Responsible for planning, documentation, and technology configuration. The project resulted in significant time savings, improved protection against vulnerabilities, and better laptop configurations aligned with company policies.",
    },
    {
      ...
      direction: "right",
      content:
        "Managed and secured approximately 1,500 external user accounts using Azure Active Directory, Active Directory, and ServiceOne. Focused on user lifecycle management, access control, security validation, and compliance within IAM and UAM processes.",
    },
    {
      ...
      direction: "left",
      content:
        "First professional IT role. Responsible for maintaining and monitoring IAM environments (including Keycloak) on Linux-based customer systems. Tasks included vulnerability detection, suspicious activity monitoring, certificate management, and remote system operations.",
    },
    {
      title: "IdentIT – Internship",
      date: "2022-2023",
      direction: "right",
      content:
        "Completed a multi-month internship project focused on a secure IoT device. Built an IAM environment using ForgeRock, requiring user authentication before accessing media content streamed via Kodi on a Raspberry Pi. This project resulted in a contract with sister company IS4U.",
    },
    {
      title: "Education",
      date: "2018-2023",
      direction: "left",
      content: "Graduated in Electronics & ICT from AP Collage.",
    },
  ];
  ...
  return (
    ...
    <div className="w-full flex flex-col items-center overflow-x-hidden pb-10">
      ...
      <div className="w-full max-w-6xl px-12 mt-10">
        <h2 className="text-4xl md:text-5xl bg-bla font-bold">
          {" "}
          My
          <span className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-red-600 to-orange-400 bg-clip-text text-transparent">
            {" "}
            Experience
          </span>
        </h2>
